...
<video width="800" controls>
  <source src="/2024-tfg-eva-fernandez/images/semana-31/setArc.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
Para hacerlo, tuve que crear un nuevo patrón, setNW, que se encargaba de esto, y, así, la función setArc la llamaría en su correspondiente caso (en pseudocódigo):
...
![setarc](/2024-tfg-eva-fernandez/images/semana-31/setarc_values.png)

Una vez conseguido este nuevo patrón, obtuve el siguiente resultado:

<video width="800" controls>
  <source src="/2024-tfg-eva-fernandez/images/semana-31/setArc_final.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
