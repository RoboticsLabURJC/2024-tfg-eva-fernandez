...
<video width="800" controls>
  <source src="/2024-tfg-eva-fernandez/images/semana-31/turn.mp4" type="video/webm">
  Your browser does not support the video tag.
</video>

Después, para la V negativa, tuve que crear un nuevo patrón, setNW, que se encargaba de esto, y, así, la función setArc la llamaría en su correspondiente caso (en pseudocódigo):
...
Una vez conseguido este nuevo patrón, obtuve el siguiente resultado (aún no esta listo, solo está el hueco para el video para cuando lo tenga):
