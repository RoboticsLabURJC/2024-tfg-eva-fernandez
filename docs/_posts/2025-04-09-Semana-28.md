...
Que, como se puede ver, funciona perfectamente, aunque esta evolucionará a lo largo del tiempo, esto es sólo para tener una base hecha de cara al futuro, cuando esta función sea realmente necesaria.