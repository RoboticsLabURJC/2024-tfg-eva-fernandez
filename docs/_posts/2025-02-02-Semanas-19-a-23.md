...
Para eso reciclé 2 códigos que ya tenía hechos, primero el que intrepreta el json com otal, y después el que hací anadar a NAO usando como datos del seno los argumentos pasados.

Después de eso, hice las siguientes pruebas:
