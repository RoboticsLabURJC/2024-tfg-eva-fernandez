...
# EXTRA 6: Arreglando el rozamiento con el suelo

Como se puede ver en los vídeos, de nuevo estaba teniendo problemas con el suelo, por lo que me propuse arreglarlo del todo para que no diera más problemas y NAO tuviera movientos limpios, sin parecer que va a caer o resabalar, para ello, lo que hice fue: