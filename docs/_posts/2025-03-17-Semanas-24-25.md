...
Como se puede ver, ahora nao se mueve muy fluido, y obedece perfectamente a los movimientos, consiguiendo levantarse sin problemas, aunque, cabe destacar que al final sí le cambié el peso de los pies para que pesasen más que la cabeza.
...
Para ello, hice otro programa basado en el anterior, pero se suscribe a las posiciones de los topics para poder "verlas".

Una vez terminado, obtuve lo siguiente:
